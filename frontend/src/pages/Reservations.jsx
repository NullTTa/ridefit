            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span
                className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${
                  r.status === 'CANCELED' ? 'bg-ridefit-bg text-ridefit-text-secondary' : 'bg-green-950 text-green-300'
                }`}
              >
            ...
            <div className="mt-3 flex items-center justify-between">
              ...
              {r.status !== 'CANCELED' && (
                <button
                  ...
                  className="text-xs text-ridefit-text-secondary hover:text-red-400 disabled:opacity-50"
                >
