  ...
  if (reservation) {
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center">
        <div className="rounded-2xl border border-green-800 bg-green-950/40 px-6 py-10">
          <p className="text-4xl" aria-hidden="true">
            ✅
          </p>
          <h1 className="mt-3 text-2xl font-bold text-ridefit-text">예약 신청이 완료됐어요</h1>
          <p className="mt-1 text-sm text-green-300">RIDEFIT 안에서만 동작하는 가상 예약이에요.</p>
    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <header className="mb-6">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {shop.sample && <span className="rounded-full bg-yellow-950 px-2 py-0.5 text-xs text-yellow-300">샘플 데이터</span>}
        </div>
